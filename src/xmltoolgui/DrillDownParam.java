 ...
 * @author msproteo
 */
public class DrillDownParam extends javax.swing.JFrame {

    /**
     * Creates new form DrillDownParam
     */
    public DrillDownParam() {
        setTitle("Drill Down Parameter");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "recurse", "exact" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        toolparamtemp.addparamattribute("hierarchy",String.valueOf(jComboBox1.getSelectedItem()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DrillDownParam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
