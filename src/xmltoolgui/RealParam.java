 ...
 * @author msproteo
 */
public class RealParam extends javax.swing.JFrame {
	...
	/**
     * Creates new form RealTool
     */
    public RealParam() {
        setTitle("Real Parameter");
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	toolparamtemp.addparamattribute("value",jTextField1.getText());
    	toolparamtemp.addparamattribute("min",jTextField2.getText());
    	toolparamtemp.addparamattribute("max",jTextField3.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RealParam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
