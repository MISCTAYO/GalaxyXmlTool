 ...
 * @author msproteo
 */
public class TextParam extends javax.swing.JFrame {
	...
	/**
     * Creates new form Textparam
     */
    public TextParam() {
        setTitle("Text Parameter");
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	toolparamtemp.addparamattribute("size",jTextField1.getText());
    	toolparamtemp.addparamattribute("value",jTextField2.getText());
    	toolparamtemp.addparamattribute("area",String.valueOf(jComboBox1.getSelectedItem()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TextParam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
